...
INSERT INTO `listas_modelo` VALUES (1,''),(2,'');
...
CREATE TABLE `listas_modelo_itens` (
  ...
  CONSTRAINT `listas_modelo_itens_ibfk_1` FOREIGN KEY (`lista_id`) REFERENCES `listas_modelo` (`id`),
...
CREATE TABLE `saida_itens` (
  ...
  KEY `material_id` (`material_id`),
  CONSTRAINT `saida_itens_ibfk_1` FOREIGN KEY (`saida_id`) REFERENCES `saidas` (`id`),
...
INSERT INTO `usuarios` VALUES (1,'Administrador','admin','$2b$12$ShmBNa9VirfCwslmGfWn5OA27jJRtS1W9jGqBhHa2WewvU/gIAOyC','admin',1),(6,'Jonatham Oliveira de Carvalho','Jonatham Oliveira','$2b$12$A7pqmmVOaK1LiB5JBVKM7ethOXJDcpOton4hm0X7GFhuCxnUwHCp.','admin',1);
...
-- Dump completed on 2026-04-28 11:40:11
